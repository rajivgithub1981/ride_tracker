...
public class RideController {
	...
	@RequestMapping(value = "/ride/update", method = RequestMethod.POST)
	public @ResponseBody Ride updateRide(@RequestBody Ride ride) {
		return rideService.updateRide(ride);
	}
	
	@RequestMapping(value = "/ride/updateBatch", method = RequestMethod.GET)
	public @ResponseBody Object batchUpdate() {
		 rideService.updateBatch();
		 return null;
	}
	...
	@RequestMapping(value = "/ride/testException", method = RequestMethod.GET)
	...
	public ResponseEntity<ErrorMessage> handleException(RuntimeException ex){
		ErrorMessage errorMessage = new ErrorMessage(HttpStatus.OK.value(),ex.getMessage());
